  ...
  return (
    <div className="About-container">
      <article className="About">
        <Typography variant="h2" gutterBottom className="About-title">
          Hi there, I'm Azeez
        </Typography>
        <Typography variant="body2" gutterBottom className="About-text">
          ...
          JavaScript library <b>REACT</b> along with its associates. With the
          ...
          want to work harder and solve the problem... I am always ready to
